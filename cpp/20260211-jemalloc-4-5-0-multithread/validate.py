...
# -*- coding: utf-8 -*-
"""
jemalloc 4.5.0 Multithread Test Validation Script
...
Note: jemalloc 4.x handles 16B allocations differently, so 16B is skipped.
...
# Note: Skip 16B for jemalloc 4.x due to different small size handling
EXPECTED = [
    # (16, 20000, 0.99),  # Skipped for jemalloc 4.x
    (32, 20000, 0.99),
    (64, 20000, 0.99),
    (128, 10000, 0.99),
    (256, 10000, 0.99),
...
def validate(data):
    ...
    print("=" * 70)
    print("jemalloc 4.5.0 Multithread Test Validation")
    print("=" * 70)
