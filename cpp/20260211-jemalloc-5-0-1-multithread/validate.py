...
# -*- coding: utf-8 -*-
"""
jemalloc multithread validation for versions that do not reliably expose 16B.

Validation:
    - 32B..3MB buckets must achieve >= 99% detection rate.
...
def validate(data):
    print("=" * 70)
    print("jemalloc Multithread Test Validation (skip 16B)")
    print("=" * 70)
