...
# -*- coding: utf-8 -*-
"""
jemalloc 5.0.1 Multithread Test Validation Script

Test program allocations:
    - 20000 x malloc(16) - jemalloc 5.0.x handles 16B differently, skipped
    - 20000 x malloc(32)
    - 20000 x malloc(64)
    - 10000 x malloc(128)
    - 10000 x malloc(256)
...
def validate(data):
    ...
    print("=" * 70)
    print("jemalloc 5.0.1 Multithread Test Validation")
    print("=" * 70)
