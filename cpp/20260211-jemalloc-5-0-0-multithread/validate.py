...
# -*- coding: utf-8 -*-
"""
jemalloc 5.0.0 Multithread Test Validation Script

Test program allocations:
    - 20000 x malloc(16) - NOTE: jemalloc 5.0.x may handle 16B differently, skipped
    - 20000 x malloc(32)
    - 20000 x malloc(64)
    - 10000 x malloc(128)
    - 10000 x malloc(256)
...
Note: 16B allocations are skipped for jemalloc 5.0.x due to allocator behavior.
"""
...
def validate(data):
    ...
    print("=" * 70)
    print("jemalloc 5.0.0 Multithread Test Validation")
    print("=" * 70)
